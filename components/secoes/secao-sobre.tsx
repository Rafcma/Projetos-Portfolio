...
import { ComparacaoRetratoASCII } from "@/components/comparacao-retrato-ascii"
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="md:w-2/5">
          <ComparacaoRetratoASCII />
          <div className="text-center text-xs text-muted-foreground mt-2">
            Rafael Costa Monte Alegre
            <br />
            <span className="text-primary/60">Programador FrontEnd/BackEnd</span>
          </div>
        </div>

        <div className="space-y-3 md:w-3/5">
          <p>
            Olá! Sou Rafael Costa Monte Alegre, um programador com afinidade em tecnologia e desenvolvimento de
            software.
          </p>

          <p>
            Com experiência como Freelancer, foco no desenvolvimento de interfaces responsivas e intuitivas para
            diversos projetos web.
          </p>
          ...
          <div className="mt-2 p-3 border border-primary/20 rounded bg-primary/5">
            ...
            <div className="space-y-2 text-sm">
              <p>
                Sou alguém que prospera com desafios. Sempre que me dizem que algo é impossível, meu primeiro pensamento
                é "como posso tornar isso possível?" Essa mentalidade me impulsiona tanto na vida pessoal quanto
                profissional.
              </p>
              ...
              <p>
                ...
                trabalho em equipe e comunicação, estou pronto para me desenvolver e crescer profissionalmente no campo
                da programação.
              </p>
            </div>
          </div>
          ...
          <p>
            Sou apaixonado por criar soluções visuais com foco em usabilidade, performance e experiência do usuário.
          </p>
